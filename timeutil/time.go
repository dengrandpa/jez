...
// 返回时间格式化的格式，如果没有传入，则默认为YYYYMMDDHHMMSS
...
// ParseTime 将字符串转换为时间，默认格式为YYYYMMDDHHMMSS
...
// RangeHours 返回一个包含时间"start"和时间"end"之间的所有小时的切片
...
// RangeDays 返回一个包含时间"start"和时间"end"之间的所有天的切片
...
// RangeMonths 返回一个包含时间"start"和时间"end"之间的所有月的切片
...
// RangeYears 返回一个包含时间"start"和时间"end"之间的所有年的切片
